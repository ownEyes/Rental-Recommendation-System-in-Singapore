...
class Config(object):
    ...
    RF_MODEL_PATH = os.path.join(
        basedir, 'models', "RatingEstimation_random_forest_model.joblib")

    MF_MODEL_PATH = os.path.join(
        basedir, 'models', "SVD_matrix_factorization_model.surprise")
    ...
    STACKING_MODEL_PATH = os.path.join(
        basedir, 'models', "stacking_model.joblib")
    TIME_SERIES_PATH = os.path.join(
        basedir, 'models', "best_timeSeries.neuralprophet")
